...
std::tuple<dai::Pipeline, int, int> createPipeline(bool enableDepth,
    ...
    // Imu
    imu->enableIMUSensor(dai::IMUSensor::ACCELEROMETER_RAW, acc_freq);
    imu->enableIMUSensor(dai::IMUSensor::GYROSCOPE_RAW, gyro_freq);
...
int main(int argc, char** argv) {
    ...
    int badParams = 0, stereo_fps, confidence, LRchecktresh, imuModeParam, detectionClassesCount, expTime, sensIso , acc_freq,gyro_freq;
